...
gem 'complex_dates',              '2.0.4',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.0.4' #:path => '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '1.2.1',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.2.1' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.1.8',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.1.8' #:path => '../../thl/engines/places_engine'

...
gem 'complex_dates',              '2.2.7',        github: 'thl/complex_dates',               tag: 'v2.2.7' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '5.4.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.4.0' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.9.4',        github: 'thl/places_engine',               branch: 'flush-stdout/MANU-5393/drc2r' #tag: 'v4.9.4' #path: '../../thl/engines/places_engine'

...
gem 'kmaps_engine',               '4.0.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v4.0.4' #path: '../engines/kmaps_engine', branch: 'persistent-search/MANU-4008/drc2r'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.7.0',        github: 'thl/places_engine',               tag: 'v4.7.0' #path: '../../thl/engines/places_engine', branch: 'persistent-search/MANU-4008/drc2r'
...
gem 'subjects_integration',       '0.1.8',        github: 'shanti-uva/subjects_integration', tag: 'v0.1.8' #path: '../engines/subjects_integration'

...
gem 'kmaps_engine',               '3.9.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.9.5' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.6.2',        github: 'thl/places_engine',               tag: 'v4.6.2' #path: '../../thl/engines/places_engine'

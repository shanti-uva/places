...
gem 'kmaps_engine',               '1.6.4',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.6.4' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.4.7',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.4.7' #:path => '../../thl/engines/places_engine'

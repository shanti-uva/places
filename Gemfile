...
gem 'kmaps_engine',               '3.1.6',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.1.6' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.3',        github: 'thl/places_integration',          tag: 'v2.1.3' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.0.9',        github: 'thl/places_engine',               tag: 'v4.0.9' #path: '../../thl/engines/places_engine'

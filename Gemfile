...
gem 'acts_as_family_tree',        '1.1.4',        github: 'thl/acts_as_family_tree',         branch: 'relation-tree/MANU-3716/drc2r' #tag: 'v1.1.4' #path: '../../thl/engines/acts_as_family_tree'
...
gem 'kmaps_engine',               '3.8.6',        github: 'shanti-uva/kmaps_engine',         branch: 'relation-tree/MANU-3716/drc2r' #tag: 'v3.8.6' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.5.5',        github: 'thl/places_engine',               branch: 'relation-tree/MANU-3716/drc2r' #tag: 'v4.5.4' #path: '../../thl/engines/places_engine'
...
gem 'universal_navigation',       '3.0.6',        github: 'thl/universal_navigation',        branch: 'relation-tree/MANU-3716/drc2r' #tag: 'v3.0.6' #path: '../../thl/engines/universal_navigation'

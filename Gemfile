...
gem 'kmaps_engine',               '5.9.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.9.1' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.2.4',        github: 'thl/places_integration',          tag: 'v2.2.4' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '5.1.6',        github: 'thl/places_engine',               tag: 'v5.1.6' #path: '../../thl/engines/places_engine'

...
gem 'cultural_network',           '0.9.3',        :git => 'git://github.com/thl/cultural_network.git',           :tag => 'v0.9.3' #:path => '../../thl/engines/cultural_network'
...
gem 'places_engine',              '3.0.4',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.0.4' #:path => '../../thl/engines/places_engine'
gem 'proxy_engine',               '2.0.1',        :git => 'git://github.com/thl/proxy_engine.git',               :tag => 'v2.0.1' #:path => '../../thl/engines/proxy_engine'
gem 'universal_navigation',       '2.0.4',        :git => 'git://github.com/thl/universal_navigation.git',       :tag => 'v2.0.4' #:path => '../../thl/engines/universal_navigation'
gem 'shanti_integration',         '2.0.8',        :git => 'git://github.com/shanti-uva/shanti_integration.git',  :tag => 'v2.0.8' #:path => '../engines/shanti_integration'

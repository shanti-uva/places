...
gem 'kmaps_engine',               '5.3.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.3.1' #branch: 'fix-places-display-for-subjects/MANU-5129/drc2r', path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.9.1',        github: 'thl/places_engine',               tag: 'v4.9.1' #branch: 'fix-places-display-for-subjects/MANU-5129/drc2r', path: '../../thl/engines/places_engine'

...
gem 'places_engine',              '5.6.0',        github: 'thl/places_engine',               tag: 'v5.6.0' #path: '../../thl/engines/places_engine'
gem 'resource_controller',        '0.9.6',        github: 'shanti-uva/resource_controller',  tag: 'v0.9.6' #path: '../engines/resource_controller'
gem 'shanti_integration',         '3.7.3',        github: 'shanti-uva/shanti_integration',   tag: 'v3.7.3' #path: '../engines/shanti_integration'

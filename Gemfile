...
gem 'kmaps_engine',               '1.1.7',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.1.7' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.1.2',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.1.2' #:path => '../../thl/engines/places_engine'
gem 'proxy_engine',               '2.0.1',        :git => 'git://github.com/thl/proxy_engine.git',                :tag => 'v2.0.1' #:path => '../../thl/engines/proxy_engine'
gem 'shanti_integration',         '2.1.3',        :git => 'git://github.com/shanti-uva/shanti_integration.git',   :tag => 'v2.1.3' #:path => '../engines/shanti_integration'
...
gem 'universal_navigation',       '2.0.8',        :git => 'git://github.com/thl/universal_navigation.git',        :tag => 'v2.0.8' #:path => '../../thl/engines/universal_navigation'

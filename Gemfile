...
gem 'kmaps_engine',               '3.9.3',        github: 'shanti-uva/kmaps_engine',         branch: 'relation-tree-solr/MANU-3901/drc2r' #tag: 'v3.9.3' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.6.1',        github: 'thl/places_engine',               branch: 'relation-tree-solr/MANU-3901/drc2r' #tag: 'v4.6.1' #path: '../../thl/engines/places_engine'

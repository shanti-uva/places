...
gem 'kmaps_engine',               '1.0.0',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',        :tag => 'v1.0.0' #:path => '../engines/kmaps_engine'
gem 'mms_integration',            '2.0.5',        :git => 'git://github.com/thl/mms_integration.git',            :tag => 'v2.0.5' #:path => '../../thl/engines/mms_integration'
gem 'places_engine',              '3.1.0',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.1.0' #:path => '../../thl/engines/places_engine'

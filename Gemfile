...
gem 'places_engine',              '5.1.4',        github: 'thl/places_engine',               tag: 'v5.1.4' #path: '../../thl/engines/places_engine'
...
gem 'shanti_integration',         '3.4.9',        github: 'shanti-uva/shanti_integration',   tag: 'v3.4.9' #path: '../engines/shanti_integration'
gem 'subjects_integration',       '0.2.8',        github: 'shanti-uva/subjects_integration', tag: 'v0.2.8' #path: '../engines/subjects_integration'

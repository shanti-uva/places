...
gem 'complex_dates',              '2.0.5',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.0.5' #:path => '../../thl/engines/complex_dates'
...
gem 'mms_integration',            '2.0.8',        :git => 'git://github.com/thl/mms_integration.git',             :tag => 'v2.0.8' #:path => '../../thl/engines/mms_integration'
...
gem 'places_engine',              '3.2.0',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.2.0' #:path => '../../thl/engines/places_engine'
...
gem 'subjects_integration',       '0.0.5',        :git => 'git://github.com/shanti-uva/subjects_integration.git', :tag => 'v0.0.5' #:path => '../engines/subjects_integration'

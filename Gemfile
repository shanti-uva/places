...
gem 'complex_dates',              '2.1.5',        github: 'thl/complex_dates',               tag: 'v2.1.5' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '3.3.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.3.4' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.2.1',        github: 'thl/places_engine',               tag: 'v4.2.1' #path: '../../thl/engines/places_engine'

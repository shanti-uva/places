...
gem 'kmaps_engine',               '5.5.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.5.0' #branch: 'refactor-flyout-search-result-popover/MANU-5491/drc2r', path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '5.0.3',        github: 'thl/places_engine',               tag: 'v5.0.3' #branch: 'refactor-flyout-search-result-popover/MANU-5491/drc2r', path: '../../thl/engines/places_engine', branch: 'flush-stdout/MANU-5393/drc2r'
...
gem 'shanti_integration',         '3.4.5',        github: 'shanti-uva/shanti_integration',   tag: 'v3.4.5' #branch: 'modify-kmaps-header/MANU-5492/drc2r', path: '../engines/shanti_integration'

...
gem 'kmaps_engine',               '3.3.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.3.1-stable' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.2.0',        github: 'thl/places_engine',               tag: 'v4.2.0' #path: '../../thl/engines/places_engine'

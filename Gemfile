...
gem 'kmaps_engine',               '4.0.9',        github: 'shanti-uva/kmaps_engine',         branch: 'improve-related-features-interface/MANU-4311/drc2r' #tag: 'v4.0.9' #path: '../engines/kmaps_engine', branch: 'persistent-search/MANU-4008/drc2r'
gem 'places_integration',         '2.1.6',        github: 'thl/places_integration',          tag: 'v2.1.6' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.7.6',        github: 'thl/places_engine',               branch: 'improve-related-features-interface/MANU-4311/drc2r' #tag: 'geoserver-code-update/MANU-4051/drc2r' #tag: 'v4.7.6', path: '../../thl/engines/places_engine', branch: 'persistent-search/MANU-4008/drc2r'

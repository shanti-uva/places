...
gem 'kmaps_engine',               '5.2.7',        github: 'shanti-uva/kmaps_engine',         branch: 'fix-places-display-for-subjects/MANU-5129/drc2r' #tag: 'v5.2.6' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.9.0',        github: 'thl/places_engine',               branch: 'fix-places-display-for-subjects/MANU-5129/drc2r' #tag: 'v4.9.0' #path: '../../thl/engines/places_engine'

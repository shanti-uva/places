...
gem 'memcache-client'
gem 'newrelic_rpm', '3.5.8.72' #'3.6.2.96'
...
gem 'kmaps_engine',               '1.7.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.2' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.5.1',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.5.1' #:path => '../../thl/engines/places_engine'

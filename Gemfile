...
gem 'cultural_network',           '0.9.4',        :git => 'git://github.com/thl/cultural_network.git',           :tag => 'v0.9.4' #:path => '../../thl/engines/cultural_network'
...
gem 'places_engine',              '3.0.5',        :git => 'git://github.com/thl/places_engine.git',              :tag => 'v3.0.5' #:path => '../../thl/engines/places_engine'

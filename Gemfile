...
gem 'kmaps_engine',               '4.1.1',        github: 'shanti-uva/kmaps_engine',         branch: 'related-features-summary-solr/MANU-4331/drc2r' #tag: 'v4.1.2' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.7',        github: 'thl/places_integration',          tag: 'v2.1.7' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.7.7',        github: 'thl/places_engine',               branch: 'related-features-summary-solr/MANU-4331/drc2r' #tag: 'v4.7.8' #path: '../../thl/engines/places_engine'

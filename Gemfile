...
gem 'kmaps_engine',               '3.9.1',        github: 'shanti-uva/kmaps_engine',         branch: 'theme-sync/MANU-3793/drc2r' #tag: 'v3.9.1' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.5.7',        github: 'thl/places_engine',               branch: 'theme-sync/MANU-3793/drc2r' #tag: 'v4.5.7' #path: '../../thl/engines/places_engine'

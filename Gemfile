...
gem 'kmaps_engine',               '1.4.5',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.4.5' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.2.9',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.2.9' #:path => '../../thl/engines/places_engine'

...
gem 'kmaps_engine',               '1.2.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.2.2' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.1.9',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.1.9' #:path => '../../thl/engines/places_engine'

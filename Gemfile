...
gem 'kmaps_engine',               '5.7.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.7.3' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '5.0.9',        github: 'thl/places_engine',               tag: 'v5.0.9' #path: '../../thl/engines/places_engine'

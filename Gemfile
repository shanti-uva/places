...
gem 'flare',                      '1.2.7',        github: 'shanti-uva/flare',                tag: 'v1.2.7' #path: '../engines/flare'
gem 'ffi-icu',                    '0.2.0',        github: 'shanti-uva/ffi-icu',              tag: 'v0.2.0' #path: '../engines/ffi-icu'
gem 'mms_integration',            '2.3.9',        github: 'thl/mms_integration',             tag: 'v2.3.9' #path: '../../thl/engines/mms_integration'
...
gem 'places_engine',              '5.1.2',        github: 'thl/places_engine',               tag: 'v5.1.2' #path: '../../thl/engines/places_engine'

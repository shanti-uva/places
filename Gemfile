...
gem 'kmaps_engine',               '5.4.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.4.4' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.9',        github: 'thl/places_integration',          tag: 'v2.1.9' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '5.0.0',        github: 'thl/places_engine',               tag: 'v5.0.0' #path: '../../thl/engines/places_engine', branch: 'flush-stdout/MANU-5393/drc2r'

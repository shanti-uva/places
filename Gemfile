...
gem 'authenticated_system',       '2.2.1',        :git => 'git://github.com/thl/authenticated_system.git',        :tag => 'v2.2.1' #:path => '../../thl/engines/authenticated_system'
gem 'complex_dates',              '2.1.0',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.1.0' #:path => '../../thl/engines/complex_dates'
gem 'complex_scripts',            '2.2.1',        :git => 'git://github.com/thl/complex_scripts.git',             :tag => 'v2.2.1' #:path => '../../thl/engines/complex_scripts'
...
gem 'interface_utils',            '2.1.1',        :git => 'git://github.com/thl/interface_utils.git',             :tag => 'v2.1.1' #:path => '../../thl/engines/interface_utils'
gem 'mms_integration',            '2.2.0',        :git => 'git://github.com/thl/mms_integration.git',             :tag => 'v2.2.0' #:path => '../../thl/engines/mms_integration'
gem 'kmaps_engine',               '2.0.2',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v2.0.2' #:path => '../engines/kmaps_engine'

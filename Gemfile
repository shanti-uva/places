...
gem 'places_engine',              '5.2.1',        github: 'thl/places_engine',               tag: 'v5.2.1' #path: '../../thl/engines/places_engine'
gem 'proxy_engine',               '2.1.8',        github: 'thl/proxy_engine',                tag: 'v2.1.8' #path: '../../thl/engines/proxy_engine'

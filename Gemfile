...
gem 'mms_integration',            '2.3.1',        github: 'thl/mms_integration',             tag: 'v2.3.1' #path: '../../thl/engines/mms_integration'
gem 'kmaps_engine',               '3.6.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.6.4' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.5',        github: 'thl/places_integration',          tag: 'v2.1.5' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.4.0',        github: 'thl/places_engine',               tag: 'v4.4.0' #path: '../../thl/engines/places_engine'

...
gem 'kmaps_engine',               '3.1.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v3.1.2' #path: '../engines/kmaps_engine'
gem 'places_integration',         '2.1.3',        github: 'thl/places_integration',          tag: 'v2.1.3' #path: '../../thl/engines/places_integration'
gem 'places_engine',              '4.0.7',        github: 'thl/places_engine',               tag: 'v4.0.7' #path: '../../thl/engines/places_engine'

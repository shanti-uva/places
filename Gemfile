...
gem 'complex_dates',              '2.0.6',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.0.6' #:path => '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '1.7.6',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.7.6' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.5.3',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.5.3' #:path => '../../thl/engines/places_engine'

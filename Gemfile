...
gem 'complex_dates',              '2.0.7',        :git => 'git://github.com/thl/complex_dates.git',               :tag => 'v2.0.7' #:path => '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '1.8.9',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.8.9' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.5.7',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.5.7' #:path => '../../thl/engines/places_engine'

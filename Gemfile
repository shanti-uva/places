...
gem 'kmaps_engine',               '1.5.7',        :git => 'git://github.com/shanti-uva/kmaps_engine.git',         :tag => 'v1.5.7' #:path => '../engines/kmaps_engine'
...
gem 'places_engine',              '3.3.7',        :git => 'git://github.com/thl/places_engine.git',               :tag => 'v3.3.7' #:path => '../../thl/engines/places_engine'
